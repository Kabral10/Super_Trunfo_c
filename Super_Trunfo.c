...
char codigo1[4], codigo2[4], nome1[30], nome2[30], estado1[30], estado2[30];
...
// primeira carta
    ...
    removernovalinha(estado1);

    printf("Escreva o nome da cidade: \n");
    fgets(nome1,20,stdin);
    removernovalinha(nome1);
...
//segunda carta
    ...
    removernovalinha(estado2);

    printf("Escreva o nome da cidade: \n");
    fgets(nome2,20,stdin);
    removernovalinha(nome2);
